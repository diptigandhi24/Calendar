...
import useWeekDates, { getCurrentMonth } from "./useWeekDates";
...
describe("testing the hooks", () => {
  test("Display the single current month in this week", () => {
    expect(getCurrentMonth(moment())).toBe("May");
  });

  test("Display the two months in this week", () => {
    expect(getCurrentMonth(moment("2021-04-28"))).toBe("April-May");
  });
